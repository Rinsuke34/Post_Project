...
// グリッドサイズ
// ※グリッドは5ブロック四方で1グリッドとし、XZ平面で管理する
static const int	GRID_SIZE_BLOCK_X	= 5;	// X軸のグリッドの大きさ(ブロック数単位)
static const int	GRID_SIZE_BLOCK_Z	= 5;	// Z軸のグリッドの大きさ(ブロック数単位)
static const int	GRID_SIZE_WORLD_X	= 320;	// X軸のグリッドの大きさ(AREA_SIZE_BLOCK_X * GRID_SIZE_BLOCK_X)
static const int	GRID_SIZE_WORLD_Z	= 320;	// Z軸のグリッドの大きさ(AREA_SIZE_BLOCK_Z * GRID_SIZE_BLOCK_Z)
static const int	GRID_NUMBER_X		= 21;	// X軸のグリッド数(AREA_SIZE_BLOCK_X / GRID_SIZE_BLOCK_X * 3)
static const int	GRID_NUMBER_Z		= 21;	// Z軸のグリッド数(AREA_SIZE_BLOCK_Z / GRID_SIZE_BLOCK_Z * 3)
...
// 基準文字サイズ
static const int BASE_FONT_SIZE = 32;	// 基準文字サイズ
...
/* サウンド系 */
static const int	VOLUME_SE_RADIUS						= 128;	// SEの音量半径
